...
Macroeconomic factor models use observable economic time series to explain the common variation in asset returns, with the unexplained, idiosyncratic, variance being asset-specific. 
...
```{r, fig.cap="Asset Returns by Industry \\label{Fig9}", fig.height=4.5, fig.width=7}
p.Indus <- new_dat %>%
    filter(Tickers %in% T40) %>%
